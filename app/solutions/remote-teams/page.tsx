        ...
        <div className="container mx-auto px-4">
          <div className="text-center max-w-3xl mx-auto mb-16 animate-reveal">
            ...
            <p className="text-gray-400 text-lg">
              Remote teams face unique challenges. Here's how Proddy helps overcome them.
            </p>
          </div>
      ...
      <section ref={productsRef} className="py-20 bg-gradient-to-b from-black to-gray-950">
        <div className="container mx-auto px-4">
          <div className="text-center max-w-3xl mx-auto mb-16 animate-reveal">
            ...
            <p className="text-gray-400 text-lg">
              These tools work together seamlessly to address the unique needs of remote teams.
            </p>
          </div>
      ...
      <section className="py-20 bg-black relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-4xl mx-auto bg-gradient-to-r from-gray-900 to-gray-900/80 rounded-xl p-8 md:p-12 border border-gray-800 text-center">
            <h2 className="text-3xl md:text-4xl font-bold mb-4">Ready to Transform Your Remote Team?</h2>
            <p className="text-xl text-gray-300 mb-8">
              Join thousands of remote teams who have improved their productivity and collaboration with Proddy.
            </p>
...
function getProductDescription(productName: string): string {
  switch (productName) {
    case "Ping":
      return "Real-time messaging with threads, reactions, and AI-powered summaries for effective team communication."
    case "Huddle":
      return "Video meetings with recordings, transcripts, and AI-generated summaries to keep everyone in sync."
    case "Canvas":
      return "Visual collaboration whiteboard for brainstorming, planning, and creative work across time zones."
    case "Notes":
      return "Collaborative documentation for knowledge sharing, meeting notes, and team resources."
    case "Flow":
      return "Project and task management to track progress, assign responsibilities, and meet deadlines."
    case "Input":
      return "Create surveys, feedback forms, and team applications to collect and analyze data from your remote team."
    case "Slots":
      return "Smart scheduling that works across time zones to find the perfect meeting times for everyone."
    case "Ticks":
      return "Personal task management to help team members organize their individual responsibilities."
    default:
