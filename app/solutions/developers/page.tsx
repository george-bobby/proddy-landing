  ...
  return (
    <>
      ...
      <section className="pt-32 pb-20 md:pt-40 md:pb-32 bg-black relative overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-tr from-blue-900/30 via-transparent to-indigo-900/10"></div>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center max-w-3xl mx-auto mb-16 animate-reveal">
            ...
            <p className="text-gray-400 text-lg">
              Development teams face unique challenges. Here's how Proddy helps overcome them.
            </p>
          </div>
      ...
      <section ref={productsRef} className="py-20 bg-gradient-to-b from-black to-gray-950">
        <div className="container mx-auto px-4">
          <div className="text-center max-w-3xl mx-auto mb-16 animate-reveal">
            ...
            <p className="text-gray-400 text-lg">
              These tools work together seamlessly to address the unique needs of development teams.
            </p>
          </div>
      ...
      <section className="py-20 bg-black relative overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-tr from-blue-900/20 via-transparent to-indigo-900/20"></div>
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-4xl mx-auto bg-gradient-to-r from-gray-900 to-gray-900/80 rounded-xl p-8 md:p-12 border border-gray-800 text-center">
            <h2 className="text-3xl md:text-4xl font-bold mb-4">Ready to Boost Your Development Workflow?</h2>
            <p className="text-xl text-gray-300 mb-8">
              Join thousands of development teams who have improved their productivity and collaboration with Proddy.
            </p>
...
function getProductDescription(productName: string): string {
  switch (productName) {
    case "Flow":
      return "Track issues, manage sprints, and visualize development progress with customizable workflows."
    case "Ping":
      return "Communicate with your team in real-time or asynchronously, with code snippets and integrations."
    case "Huddle":
      return "Run effective standups, planning sessions, and code reviews with video meetings and recordings."
    case "Canvas":
      return "Visualize architecture, data flows, and system designs with collaborative diagramming."
    case "Notes":
      return "Create and maintain technical documentation, API references, and knowledge bases."
    case "Slots":
      return "Schedule meetings and coordinate across teams with smart calendar management."
    case "Ticks":
      return "Manage your personal tasks and to-dos alongside your development responsibilities."
    default:
